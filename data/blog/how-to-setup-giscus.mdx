...
date: '2022-08-12'
lastmod: '2022-08-12'
tags: ['build-a-blog', 'blog-comment-section', 'giscus', 'how-to']
draft: false
summary: '逐步介紹在 next.js blog starter 要如何串接 giscus 留言板服務'
images: []
---
...
![檔案 siteMetadata.js 程式碼片段，屬性 siteMetadata.comment](/static/images/2022/site-metadata-comment.png)

確認 provider 有設置正確，根據註解提示走訪 [giscus 頁面](https://giscus.app/) 看到 Configuration 區塊 (如下圖)  

![giscus app 網頁，Configuration 區塊](/static/images/2022/giscus-app-configuration.png)
