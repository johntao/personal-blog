...
date: '2022-07-23'
lastmod: '2022-08-06'
tags: ['build-a-blog', 'solution-stack', 'jamstack', 'tailwindcss', 'react', 'next-js', 'intro', 'tech-skills-basic']
draft: false
summary: '介紹 Jamstack 技術，分享建立一個部落格，技術面會有哪些決策以及執行步驟'
images: []
---
...
- 未來希望能實作 reference popup 的效果Ｆ，這樣就能隨心所欲的置入迷因和 buzzwords 😆
